        ...
        <span
            className="grid h-20 w-20 place-items-center rounded-full bg-primary transition-all duration-300 group-hover:bg-secondary-300">
                ...
                <div className="pt-5 text-base font-semibold leading-7">
                  <p>
                  <Link to={`/Respdetails-retenus/${startDate}/${endDate}/${title}/${id}`} className="text-black transition-all duration-300 group-hover:text-white">Ouvrir &rarr;</Link>
                  </p>
                </div>
              </div>
            </div>
...
export default RespProjetRetenus;