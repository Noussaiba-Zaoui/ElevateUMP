...
const RespCalNavbar = ({sessionId,startDate,endDate }) => {
    ...
    const links = [
      {
        ...
        dropdown: true,
        children: [
          { id: 6, name: "Calendrier de passage", link: `/VoirCalenderPassage/${startDate}/${endDate}/${sessionId}` },
          { id: 7, name: "Calendrier d'entretien", link: `/VoirCalenderEntretien/${startDate}/${endDate}/${sessionId}` },
        ]
      },
