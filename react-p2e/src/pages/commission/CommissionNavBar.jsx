...
const CommissionNavbar = ({sessionId,startDate,endDate }) => {
    ...
    const links = [
      {
        ...
        dropdown: true,
        children: [
          { id: 6, name: "Calendrier de passage", link: `/CommissionVoirCalenderPassage/${startDate}/${endDate}/${sessionId}` },
          { id: 7, name: "Calendrier d'entretien", link: `/CommissionVoirCalenderEntretien/${startDate}/${endDate}/${sessionId}` },
        ]
      },
      {
        id: 3,
        name: "liste des utilisateurs",
        link: `/VoirUsers/${startDate}/${endDate}/${sessionId}`,
      },
      {
        id: 4,
        name: "Accueil",
    ...
    <div className="relative z-10 w-full duration-300">
      <div className="container py-3 md:py-2">
        <div className="flex justify-between items-center">
          {/* Logo section */}
          <Link to="/commissionHome" className="flex items-center gap-3">
            <img src={Logo} alt="" />
          </Link>
