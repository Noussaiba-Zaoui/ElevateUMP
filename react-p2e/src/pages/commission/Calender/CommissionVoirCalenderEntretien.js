...
const CommissionVoirCalendarEntretion = () => {
    ...
    <>
      ...
      <div className="max-w-xl mt-20 mx-auto text-center xl:max-w-2xl">
        <h2 className="text-3xl font-semibold leading-tight text-black sm:text-2xl xl:text-4xl mb-6">
          ...
          <span className="text-purple-700">Session du Session du {startDate} au {endDate}</span>
        </h2>
      </div>
...
export default CommissionVoirCalendarEntretion;
