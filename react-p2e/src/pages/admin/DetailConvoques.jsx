...
import RespCalNavbar from '../RespoCalender/NavBars/RespCalNavbar';
const DetailConvoques = () => {
  ...
  const renderMembers = (members) => {
    if (members) {
      // Split the members string by newline character
 ...
 <>
   ...
   <AdminNavbar startDate={startDate}  endDate={endDate}sessionId={id}/>
    ...
    {projectDetails && (
                ...
                <img src={projetConvoquer} alt="projetRetenue" className="h-10 w-10 text-white"/>
                </span>
...
export default DetailConvoques;