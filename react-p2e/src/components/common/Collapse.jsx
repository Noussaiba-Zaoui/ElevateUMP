...
const { IconChevronDown, IconChevronUp } = Icons;

const Collapse = ({ items, classCollapseItem, iconUp, iconDown }) => {
          ...
          <div className={classCollapseItem}>
            ...
            >
              ...
              {iconDown && iconUp ? (
                ...
                <Icons.IconChevronUp className="h-6 w-6 text-primary-600 " />
              ) : (
                <Icons.IconChevronDown className="h-6 w-6 text-primary-600 " />
              )}
            </div>
            {activeIndex === index && (
              <div
