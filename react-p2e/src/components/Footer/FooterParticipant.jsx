...
const Footer = () => {
  return (
      <div id="footerParticipant" className="bg-dark text-white">
                ...
                <div className="py-8 px-4">
                  ...
                  <ul className={`flex flex-col gap-3`}>
                    <li className="cursor-pointer hover:translate-x-1 duration-300 hover:!text-primary space-x-1 text-gray-400 ">
                      <a href="/participantHome#heroParticipant">Accueil</a>
                    </li>
                    <li className="cursor-pointer hover:translate-x-1 duration-300 hover:!text-primary space-x-1 text-gray-400 ">
                      <a href="/participantHome#defp2eParticipant">Explorez notre Programme </a>
                    </li>
                    <li className="cursor-pointer hover:translate-x-1 duration-300 hover:!text-primary space-x-1 text-gray-400 ">
                      <a href="/participantHome#servicesPartcipant">Services</a>
                    </li>
                    <li className="cursor-pointer hover:translate-x-1 duration-300 hover:!text-primary space-x-1 text-gray-400 ">
                      <a href="/participantHome#footerParticipant">Contact</a>
                    </li>
                  </ul>
                </div>
              </div>
